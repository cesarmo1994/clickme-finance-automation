...
- `dbo.vw_invoice_summary`: high-level invoice count, review count, parsed count, total amount, and date range.
...
- Should documents store only metadata or also Azure Blob Storage references?
